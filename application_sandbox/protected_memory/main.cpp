...
class ProtectedMemorySample : public sample_application::Sample<CubeFrameData> {
 public:
  ProtectedMemorySample(const entry::EntryData* data)
      : data_(data),
...
int main_entry(const entry::EntryData* data) {
  ...
  ProtectedMemorySample sample(data);
  sample.Initialize();
