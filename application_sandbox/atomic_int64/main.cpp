...
class AtomicInt64Sample : public sample_application::Sample<TriangleFrameData> {
 public:
  AtomicInt64Sample(const entry::EntryData* data,
...
int main_entry(const entry::EntryData* data) {
  ...
  AtomicInt64Sample sample(data, request_features);
  sample.Initialize();
