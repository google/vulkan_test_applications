...
class CubeSample : public sample_application::Sample<CubeFrameData> {
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    cube_pipeline_->SetPipelineExtensions(&pcfci);
    cube_pipeline_->AddAttachment();
    cube_pipeline_->Commit();

    app()->instance()->GetLogger()->LogInfo("PipelineCreationFeedback:");
    if (pcf.flags & VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT_EXT) {
