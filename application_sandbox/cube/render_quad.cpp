...
void RenderQuad::InitializeCubeData(vulkan::VulkanApplication* app,
...
void RenderQuad::RecordRenderCmds(vulkan::VulkanApplication* app,
...
void RenderQuad::Render(vulkan::VkQueue* queue, size_t frame_index) {
