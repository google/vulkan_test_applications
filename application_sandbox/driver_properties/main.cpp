 ...
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    app()->GetLogger()->LogInfo(
        "DriverID: ", driver_id_names[device_driver_properties.driverID]);
    app()->GetLogger()->LogInfo("DriverName: ",
                                device_driver_properties.driverName);
    app()->GetLogger()->LogInfo("DriverInfo: ",
                                device_driver_properties.driverInfo);
    app()->GetLogger()->LogInfo(
        "ConformanceVersion: ",
        static_cast<uint16_t>(
            device_driver_properties.conformanceVersion.major),
        ".",
        static_cast<uint16_t>(
            device_driver_properties.conformanceVersion.minor),
        ".",
        static_cast<uint16_t>(
            device_driver_properties.conformanceVersion.subminor),
        ".",
        static_cast<uint16_t>(
            device_driver_properties.conformanceVersion.patch));
  }
