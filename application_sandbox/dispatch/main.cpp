...
#include "dispatch.vert.spv"
    ;

uint32_t cube_fragment_shader[] =
#include "dispatch.frag.spv"
    ;

uint32_t compute_shader[] =
#include "dispatch.comp.spv"
    ;
...
class DispatchSample : public sample_application::Sample<CubeFrameData> {
 public:
  DispatchSample(const entry::EntryData* data)
      : data_(data),
