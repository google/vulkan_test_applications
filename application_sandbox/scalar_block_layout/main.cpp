...
#include "scalar_block_layout.vert.spv"
    ;

uint32_t fragment_shader[] =
#include "scalar_block_layout.frag.spv"
    ;
...
VkPhysicalDeviceScalarBlockLayoutFeaturesEXT scalar_block_info{
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT,
    nullptr,  // pNext
    true      // scalarBlockLayout
};
...
class CubeSample : public sample_application::Sample<CubeFrameData> {
 public:
      ...
      : data_(data),
        Sample<CubeFrameData>(
            ...
            sample_application::SampleOptions()
                .EnableMultisampling()
                .AddDeviceExtensionStructure(&scalar_block_info),
  ...
  virtual void InitializeApplicationData(
    ...
    color_data_->data().color1 = Vector3(1.0, 1.0, 0.0);
    color_data_->data().color2 = Vector3(1.0, 1.0, 1.0);
  }
