 ...
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    VkPhysicalDeviceProperties2 physical_device_properties2{
        ...
        &physical_device_pci_bus_info_properties,  // pNext;
        {},                                        // properties
    };
    app()->instance()->vkGetPhysicalDeviceProperties2KHR(
        app()->device().physical_device(), &physical_device_properties2);

    app()->instance()->GetLogger()->LogInfo("PCI Bus Info: ");
    app()->instance()->GetLogger()->LogInfo(
        "    PCI bus domain: ",
        physical_device_pci_bus_info_properties.pciDomain);
    app()->instance()->GetLogger()->LogInfo(
        "    PCI bus identifier: ",
        static_cast<uint16_t>(physical_device_pci_bus_info_properties.pciBus));
    app()->instance()->GetLogger()->LogInfo(
        "    PCI device identifier: ",
        static_cast<uint16_t>(
            physical_device_pci_bus_info_properties.pciDevice));
    app()->instance()->GetLogger()->LogInfo(
        "    PCI device function identifier: ",
        static_cast<uint16_t>(
            physical_device_pci_bus_info_properties.pciFunction));
