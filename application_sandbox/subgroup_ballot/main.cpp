...
class SubgroupBallotSample
    : public sample_application::Sample<TriangleFrameData> {
 public:
  SubgroupBallotSample(const entry::EntryData* data,
 ...
 private:
  ...
  VkDescriptorSetLayoutBinding triangle_descriptor_set_layouts_[2];
...
int main_entry(const entry::EntryData* data) {
  ...
  request_features.shaderInt64 = VK_TRUE;
  SubgroupBallotSample sample(data, request_features);
  sample.Initialize();
