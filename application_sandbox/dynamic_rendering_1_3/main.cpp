...
VkPhysicalDeviceDynamicRenderingFeatures kDynamicRenderingFeat{
...
class CubeSample : public sample_application::Sample<CubeFrameData> {
 public:
      ...
      : data_(data),
        Sample<CubeFrameData>(
            ...
            sample_application::SampleOptions()
                .EnableMultisampling()
                .AddDeviceExtensionStructure(&kDynamicRenderingFeat)
  ...
  virtual void InitializeApplicationData(
    ...
    VkPhysicalDeviceDynamicRenderingFeatures ext_features{
    ...
    if (ext_features.dynamicRendering == VK_FALSE) {
      data_->logger()->LogError("Dynamic rendering not supported");
      exit(1);
    }
    ...
    vulkan::VkRenderPass render_pass(nullptr, nullptr, nullptr);
    cube_pipeline_ = containers::make_unique<vulkan::VulkanGraphicsPipeline>(
        data_->allocator(),
        app()->CreateGraphicsPipeline(pipeline_layout_.get(), &render_pass, 0));
    VkFormat colorAttachmentFormat = render_format();
    VkPipelineRenderingCreateInfo pipeline_rendering_create_info = {
        VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO,  // sType
        nullptr,                                           // pNext
        0,                                                 // viewMask
    ...
    cube_pipeline_->SetPipelineExtensions(&pipeline_rendering_create_info);
  ...
  virtual void InitializeFrameData(
    ...
    VkRenderingAttachmentInfo color_attachment = {
        VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,  // sType
        nullptr,                                      // pNext
        color_view(frame_data),                       // imageView
        VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL,           // imageLayout
        VK_RESOLVE_MODE_NONE,                         // resolveMode
    ...
    VkRenderingInfo rendering_info = {
        VK_STRUCTURE_TYPE_RENDERING_INFO,  // sType
        nullptr,                           // pNext
        0,                                 // flags
        {{0, 0},
         {app()->swapchain().width(),
    ...
    cmdBuffer->vkCmdBeginRendering(cmdBuffer, &rendering_info);
    ...
    cmdBuffer->vkCmdEndRendering(cmdBuffer);
