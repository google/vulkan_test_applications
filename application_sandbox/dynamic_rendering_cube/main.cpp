...
VkPhysicalDeviceDynamicRenderingFeaturesKHR kDynamicRenderingFeat{
...
class CubeSample : public sample_application::Sample<CubeFrameData> {
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    VkPhysicalDeviceDynamicRenderingFeaturesKHR ext_features{
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES_KHR,
        nullptr,
        VK_FALSE,
    };
  ...
  virtual void InitializeFrameData(
    ...
    VkRenderingAttachmentInfoKHR color_attachment = {
        VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO_KHR,    // sType
        nullptr,                                            // pNext
        color_view(frame_data),                             // imageView
        VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR,             // imageLayout
    ...
    VkRenderingInfoKHR rendering_info = {
        VK_STRUCTURE_TYPE_RENDERING_INFO_KHR,   // sType
        nullptr,                                // pNext
        0,                                      // flags
        {{0, 0},
         {app()->swapchain().width(),
    ...
    cmdBuffer->vkCmdBeginRenderingKHR(cmdBuffer, &rendering_info);
    ...
    cmdBuffer->vkCmdEndRenderingKHR(cmdBuffer);
