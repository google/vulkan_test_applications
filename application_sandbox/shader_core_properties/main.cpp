...
class CubeSample : public sample_application::Sample<CubeFrameData> {
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    physical_device_properties.pNext = &shader_core_properties;
    ...
    app()->GetLogger()->LogInfo("Number of shader engines: ",
    ...
    app()->GetLogger()->LogInfo("Number of SIMDs per compute unit: ",
                                shader_core_properties.simdPerComputeUnit);
    app()->GetLogger()->LogInfo("Number of wavefront slots in each SIMD: ",
                                shader_core_properties.wavefrontsPerSimd);
    app()->GetLogger()->LogInfo("Number of threads per wavefront: ",
                                shader_core_properties.wavefrontSize);
    app()->GetLogger()->LogInfo("Number of physical SGPRs per SIMD: ",
    ...
    app()->GetLogger()->LogInfo("Number of available SGPRs: ",
    ...
    app()->GetLogger()->LogInfo("Number of physical VGPRs per SIMD: ",
    ...
    app()->GetLogger()->LogInfo("Number of available VGPRs: ",
