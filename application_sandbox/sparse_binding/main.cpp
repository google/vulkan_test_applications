...
uint32_t sparse_binding_vertex_shader[] =
#include "sparse_binding.vert.spv"
    ;

uint32_t sparse_binding_fragment_shader[] =
#include "sparse_binding.frag.spv"
    ;
...
const size_t kSparseBindingBlockSize = 1024u;

namespace {
VkPhysicalDeviceFeatures enableSparseBindingFeature() {
 ...
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    cube_pipeline_->AddShader(VK_SHADER_STAGE_VERTEX_BIT, "main",
                              sparse_binding_vertex_shader);
    cube_pipeline_->AddShader(VK_SHADER_STAGE_FRAGMENT_BIT, "main",
                              sparse_binding_fragment_shader);
