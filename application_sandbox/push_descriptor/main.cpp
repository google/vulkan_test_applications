...
class CubeSample : public sample_application::Sample<CubeFrameData> {
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    VkDescriptorSetLayoutBinding cube_descriptor_set_layouts[2] = {
        {
            0,                                  // binding
    ...
    pipeline_layout_ = containers::make_unique<vulkan::PipelineLayout>(
        ...
        app()->CreatePipelineLayout(
            {{{cube_descriptor_set_layouts[0], cube_descriptor_set_layouts[1]},
  ...
  virtual void InitializeFrameData(
    ...
    cmdBuffer->vkCmdPushDescriptorSetKHR(cmdBuffer,
                                         VK_PIPELINE_BIND_POINT_GRAPHICS,
                                         *pipeline_layout_, 0, 1, &write);
