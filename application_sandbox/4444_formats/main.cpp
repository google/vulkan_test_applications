...
} texture = {VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT,
             2,
             2,
             {
                 {0xF, 0, 0, 0xF},
...
VkPhysicalDevice4444FormatsFeaturesEXT kFeat{
 ...
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    texture_.InitializeData(app(), initialization_buffer,
                            ...
                            VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT, nullptr);

    VkPhysicalDevice4444FormatsFeaturesEXT ext_features{
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT,
        nullptr,
        VK_FALSE,
        VK_FALSE,
    ...
    if (ext_features.formatA4B4G4R4 == VK_FALSE) {
      data_->logger()->LogError(
          "VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT format not supported");
      exit(1);
    }
    if (ext_features.formatA4R4G4B4 == VK_FALSE) {
      data_->logger()->LogError(
          "VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT format not supported");
      exit(1);
    }
